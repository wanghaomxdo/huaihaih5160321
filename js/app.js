...
/*-- arry
====================================================== */
var lg = ["请您填写上述信息","请您补全信息","请输入正确的11位号码","请输入正确的邮箱信息","信息正在提交中，请稍后...","报名信息提交成功！","信息已提交，请不要重复提交！","信息提交失败，请重试！"];
var enlg = ["Please leave the correct information","Please wait...","Submitted successfully","Please do not submit a duplicate","Submit failure, please try again"];
/*-- P1
====================================================== */
app.p1 = function(){};
...
function ImgShow(evt){
    ...
    var closeTag=document.createElement("div");
        ...
        var closesHtml="<b style='background:#16223B;border:1px solid white;filter:Alpha(Opacity=100);Opacity:1;cursor:pointer;font-size:28px;color:#A89A7B'>&nbsp;关闭&nbsp;长按保存</b>";
